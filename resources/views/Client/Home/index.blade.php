   ...
   <body id="page-top" data-spy="scroll" data-target=".navbar-custom">
            ...
            <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsscale:1.2;">
               ...
               <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
                  <div class="header-text">
                     ...
                     <p class="header-p">We have over 300 delicious flavours for you to choose, come and visit our shop today!   
                     </p>
                     <!-- Button -->
                     <a  href="#contact">
      ...
      <section id="services" class="no-padding-top container-fluid" data-0="background-position:90% 100px;" data-end="background-position:90% -300px;" >
         <div class="container" >
            ...
            <div class="row">
			    <div class="col-md-4">
                  <img class="img-responsive img-rounded" src="/ClientPublic/img/cakes.jpg" data-aos="fade-down"  data-aos-duration="1500"  alt="">			   
               </div>
               <!-- /col-md-4 -->
               <div class="col-md-8 res-margin">
                  <h3>Baking is our Passion</h3>
                  <p>Hinc dissentiet per ad, quando dolores has id vel mauris ultricies, vest ibulum orci eget Unc vel mauris ultricies, vest ibulum orci eget,Fusce mollis viverra elit liquam erat volut imperdiet interdum donec eget me</p>
                    <p> Atomorum erroribus dissentiunt ex vel. Invenire hendrerit et vim, has solet adversarium ne, mea nisl postea principes at. Has primis vidisse instructior ad, id rebum eruditi sed. Hinc dissentiet per ad, quando dolores has id vel mauris ultricies, vest ibulum orci eget.   
                  </p>			   
				  <!-- Button -->
      ...
      <section id="newsletter" class="container-fluid bg-primary">
         <div class="container">
            <div class="row">
               <div class="col-lg-5">
                  <!-- image  -->
                  <img src="/ClientPublic/img/newsletter.png" class="img-responsive newsletter-img" alt="" />
               </div>
               <div class="col-lg-5">
                        ...
                        <div id="mc_embed_signup_scroll">
                           <div class="mc-field-group">
                              <div class="input-group">
                                 ...
                                 <button class="blob-btn btn btn-lg" type="submit" value="Subscribe" name="subscribe"  id="mc-embedded-subscribe">
                                 Subscribe
                                 <span class="blob-btn__inner">
                                 <span class="blob-btn__blobs">
                                 <span class="blob-btn__blob"></span>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-7">
                  ...
                  <p>Placerat a ultricies a, posuere a nibh. Fusce mollis imperdiet interdum donec eget metus auguen unc vel mauris ultricies, vest ibulum orci eget,Fusce mollis imperdiet interdum donec eget metus auguen unc vel lorem ispuet.</p>
				  <p>Placerat a ultricies a, posuere a nibh lorem ispuet Ibu lum orci eget.Ibu lum orci eget, viverra elit liquam erat volut pat phas ellus ac sodales Lorem ipsum dolor sit amet, consectetur adipisicing elit uasi quidem minus id omnis.
                  </p>
                  <ul class="custom">
               ...
               <div class="col-lg-5 res-margin">
                  <div id="owl-about" class="owl-carousel">
                     <div class="item">
                        <img class="img-responsive img-rounded" src="/ClientPublic/img/about1.jpg" alt="">
                     </div>
                     <div class="item">
                        <img class="img-responsive  img-rounded" src="/ClientPublic/img/about2.jpg" alt="">
                     </div>
                     <div class="item">
                        <img class="img-responsive  img-rounded" src="/ClientPublic/img/about3.jpg" alt="">
                     </div>
                  </div>
                  <!-- /owl-about -->
               </div>
         ...
         <div class="container">
            ...
            <div class="col-md-12">
               ...
               <ul class="nav nav-pills pills-custom nav-stacked col-lg-3" id="menu-nav">
                  <li class="active"><a href="#tab_a" data-toggle="pill"><i class="icon flaticon-food-4"></i>Cakes & Pies</a></li>
                  <li><a href="#tab_b" data-toggle="pill"><i class="icon flaticon-cupcake-2"></i>Cupcakes</a></li>
                  <li><a href="#tab_c" data-toggle="pill"><i class="icon flaticon-cookies"></i>Cookies & Bars</a></li>
      ...
      <section id="team">
         <div class="container">
            ...
            <!-- Parallax object -->
            <div class="parallax-object hidden-sm hidden-xs hidden-md " data-bottom-top="right:15%;margin-top:-100px;transform:rotate(-10deg);" data-top="transform:rotate(0deg);" >
               <!-- Image -->
      ...
      <!--/ Section --> 
      <!-- ==== Call to Action ==== -->
      <section id="call-to-action" class="border-shape container-fluid" data-0="background-position:100% 20px;" data-end="background-position:100% -40px">
         <div class="container">
               ...
               <div class="col-md-5">
                  ...
                  <div class="form-style" id="contact_form">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control input-field" placeholder="" required=""> 
                        <label>Subject</label>						
